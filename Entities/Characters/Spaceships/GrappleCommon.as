...
const float chainLinkDist = 4.0f;
const u8 grappleMaxTicks = 90;

Random _grapple_r(95444);

void grappleSync( CBlob@ this, bool isDeployed = false, u16 hookBlobNetID = 0, f32 chainLength = 0.0f, u16 grappledBlobNetID = 0 )
{
	CBitStream params;
	params.write_bool(isDeployed);
...
void makeStraightChain(Vec2f fromPos = Vec2f_zero, Vec2f toPos = Vec2f_zero)
{
	...
	for(int i = 0; i < steps; i += chainLinkDist) //particle loop
	{
