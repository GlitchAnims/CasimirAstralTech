...
void LoadSprites(CSprite@ this)
{
	...
	if (forFire1 !is null)
	{
		...
		forFire1.SetOffset(Vec2f(9.5f, 32.0f));
	}
	if (forFire2 !is null)
	{
		...
		forFire2.SetOffset(Vec2f(-9.5f, 32.0f));
	}
	if (backFire1 !is null)
	{
		...
		backFire1.SetOffset(Vec2f(3.5f, -33.0f));
	}
	if (backFire2 !is null)
	{
		...
		backFire2.SetOffset(Vec2f(-3.5f, -30.0f));
	}
	if (portFire1 !is null)
	{
		...
		portFire1.SetOffset(Vec2f(7.5f, -27.5f));
	}
	if (portFire2 !is null)
	{
		...
		portFire2.SetOffset(Vec2f(16.5f, 28.0f));
	}
	if (starboardFire1 !is null)
	{
		...
		starboardFire1.SetOffset(Vec2f(-7.5f, -27.5f));
	}
	if (starboardFire2 !is null)
	{
		...
		starboardFire2.SetOffset(Vec2f(-16.5f, 28.0f));
	}
